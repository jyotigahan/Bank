...
public class TransactionDaoTest {
    ...
    public void initTestData() {
        ...
        transaction1 = new Transaction(BankAccountDao.JYOTI, BankAccountDao.RANJAN,BigDecimal.ONE);
        transaction1.setId(TRANSACTION_1_ID);

        transaction2 = new Transaction(BankAccountDao.RANJAN, BankAccountDao.GAHAN, BigDecimal.TEN);
    ...
    @Test(description = "Tests that wrong bank transaction will fail in database with ObjectModificationException", expectedExceptions = ObjectModificationException.class)
     public void testWrongTransactionCreation() throws ObjectModificationException {
        ...
        Transaction transaction = new Transaction( BankAccountDao.RANJAN, BankAccountDao.GAHAN, BigDecimal.valueOf(10000));
