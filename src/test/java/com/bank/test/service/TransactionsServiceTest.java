...
public class TransactionsServiceTest {
    ...
    @Description ( "Test Description: Verify all bank transaction retrival successful")
 	@Test (description= "Tests that method will successfully retrive all bank transactions from database")
       public void testAllTransactionsRetrieval(){
        ...
        Collection<Transaction> testList = Arrays.asList(
                new Transaction( BankAccountDao.JYOTI,BankAccountDao.RANJAN, BigDecimal.ZERO ),
                new Transaction(BankAccountDao.RANJAN,BankAccountDao.GAHAN,BigDecimal.ZERO )
        );
    ...
    @Description ( "Test Description: Verify bank transaction will unsuccessful without sender's account")
     ...
     public void testCreateTransactionWithNullFrom() throws ObjectModificationException {
        ...
        staticTransactionService.createTransaction(new Transaction( null, 2L, BigDecimal.TEN ));
    }

    @Description ( "Test Description: Verify bank transaction will unsuccessful without receiver's account")
    ...
    public void testCreateTransactionWithNullTo() throws ObjectModificationException {
        ...
        staticTransactionService.createTransaction(new Transaction(1L, null, BigDecimal.TEN ));
    }

   
    @Description ( "Test Description: Verify bank transaction will unsuccessful with same account")
     ...
     public void testCreateTransactionWithSameAccounts() throws ObjectModificationException {
        staticTransactionService.createTransaction(new Transaction(BankAccountDao.JYOTI,BankAccountDao.JYOTI, BigDecimal.TEN ));
    }

  
    @Description ( "Test Description: Verify bank transactions will unsuccessful with zero account")
    ...
    public void testCreateTransactionWithZeroAmount() throws ObjectModificationException {
        staticTransactionService.createTransaction(new Transaction(BankAccountDao.JYOTI, BankAccountDao.RANJAN, BigDecimal.ZERO ));
    }

    @Description ( "Test Description: Verify bank transaction creation and execution will successful")
     ...
     public void testCreateTransaction() throws ObjectModificationException {
        ...
        Transaction transaction = new Transaction(BankAccountDao.JYOTI,BankAccountDao.RANJAN, BigDecimal.TEN );
