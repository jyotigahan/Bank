 ...
 * individual with <code>ownerName</code>. and <code>balance</code> . Once there is any PLANNED transferring transaction in the system relates to this Bank Account, the transaction amount is
